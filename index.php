<?
// Change this to true to allow errors to be displayed
define('debug', false);
			...
			<div class="header-menu">
				<div class="col-md-3">
					<div class="header-left">
						...
						<select name="demoID" id="demoID" class="form-control" OnChange='window.location.href = "index.php?demoID=" + document.getElementById("demoID").options[document.getElementById("demoID").selectedIndex].value'>
