...
file_put_contents('../config.JSON', json_encode($config));		// We write the JSON file. This will write ugly JSON. I tried to use JSON_PRETTY_PRINT, bit it's not working. Have no idea why.
?>